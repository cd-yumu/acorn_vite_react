...
function UserUpdateForm(props) {
    ...
    const handleDrop = (e)=>{
        ...
        console.log(files);
        // 사실, files 는 찐 배열이 아니다. 
        // index 방 참조만 가능, map 이나 filter 함수 사용 불가
        */
    ...
    return (
        <>
            ...
            <h1>개인 정보 수정 양식</h1>
            <Form onReset={hadleReset} onSubmit={handleSubmit}>
                ...
                <Form.Group>
                    ...
                    <Form.Control onChange={handleChange} ref={imageInput} style={{display:"none"}} 
